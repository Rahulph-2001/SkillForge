        ...
        <div className="min-h-screen bg-background">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-muted-foreground mt-2">Connect with like-minded learners and experts</p>
                </div>
                ...
                <div className="relative mb-8">
                    ...
                    <input
                        ...
                        className="w-full pl-12 pr-4 py-3 bg-card border border-input rounded-xl focus:ring-2 focus:ring-primary focus:border-transparent outline-none shadow-sm text-foreground placeholder:text-muted-foreground"
                    />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                    {stats.map((stat, idx) => (
                        <div key={idx} className="bg-card p-5 rounded-xl shadow-sm border border-border">
                ...
                {!loading && communities.length === 0 && (
                    <div className="text-center py-16 bg-card rounded-xl border border-border shadow-sm">
                        ...
                        <p className="text-muted-foreground mb-6">Try adjusting your filters or create a new community.</p>
                        <button
                            onClick={() => setShowCreateModal(true)}
                            className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-3 rounded-lg font-semibold shadow-md shadow-primary/20 transition-all flex items-center gap-2 mx-auto"
                        >
                ...
                {!loading && communities.length > 0 && (
                    <div className="flex justify-center mt-12 mb-8">
                        <div className="bg-primary/5 p-8 rounded-2xl text-center w-full max-w-2xl border border-primary/10">
                            <div className="mx-auto w-12 h-12 bg-primary/10 rounded-full flex items-center justify-center mb-4">
                                <Users className="w-6 h-6 text-primary" />
                            </div>
                            <h3 className="text-lg font-bold text-foreground mb-1">Want to create your own community?</h3>
                            <p className="text-muted-foreground mb-6 text-sm">Build a space for people to connect, share knowledge, and grow together</p>
                            <button
                                onClick={() => setShowCreateModal(true)}
                                className="bg-primary hover:bg-primary/90 text-primary-foreground px-6 py-2.5 rounded-lg font-semibold shadow-lg shadow-primary/20 hover:shadow-xl transition-all flex items-center gap-2 mx-auto"
                            >
