                                ...
                                <div className="mt-2">
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-4">
                                        <div>
                                            ...
                                            <div className="mt-1 relative rounded-md shadow-sm">
                                                ...
                                                <input
                                                    ...
                                                    name="amount"
                                                    id="amount"
                                                    className="focus:ring-orange-500 focus:border-orange-500 block w-full pl-7 pr-12 sm:text-sm border-border bg-background rounded-md py-2 border text-foreground placeholder-muted-foreground"
                                                    placeholder="0.00"
                                                    value={amount}
                                        ...
                                        <div className="bg-muted/40 p-3 rounded-md border border-border">
                                            <h4 className="text-xs font-semibold text-muted-foreground uppercase mb-2">Deposit To</h4>
                                                ...
                                                <div className="text-sm">
                                                    {bankDetails?.bank_name ? (
                                                        <>
                                                            ...
                                                            <p className="text-muted-foreground">****{bankDetails.account_number?.slice(-4)}</p>
                                                        </>
                                                    ) : (
                                                        <p className="text-destructive">No bank details found. Please update your profile.</p>
                                                    )}
                                                </div>
                                            </div>
                                        </div>
