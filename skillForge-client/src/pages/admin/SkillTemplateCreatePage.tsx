...
export default function SkillTemplateCreatePage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="p-6">
        <div className="max-w-3xl mx-auto bg-card rounded-lg border border-border shadow-sm">
          {/* Header */}
          <div className="flex justify-between items-start p-6 border-b border-border">
            <div>
              <p className="text-xs uppercase tracking-wide text-muted-foreground mb-1">Skill Templates</p>
