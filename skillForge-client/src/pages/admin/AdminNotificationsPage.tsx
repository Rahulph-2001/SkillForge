...
const AdminNotificationsPage = () => {
    ...
    const getNotificationIcon = (type: NotificationType) => {
        ...
        const iconMap: Record<string, { icon: JSX.Element; bgColor: string; iconColor: string }> = {
            [NotificationType.NEW_USER_REGISTERED]: { icon: <Users className={iconClass} />, bgColor: 'bg-green-100', iconColor: 'text-green-600' },
            [NotificationType.NEW_SKILL_PENDING]: { icon: <Briefcase className={iconClass} />, bgColor: 'bg-blue-100', iconColor: 'text-blue-600' },
            [NotificationType.NEW_REPORT_SUBMITTED]: { icon: <Shield className={iconClass} />, bgColor: 'bg-red-100', iconColor: 'text-red-600' },
            [NotificationType.WITHDRAWAL_REQUESTED]: { icon: <CreditCard className={iconClass} />, bgColor: 'bg-amber-100', iconColor: 'text-amber-600' },
            // ... existing types
