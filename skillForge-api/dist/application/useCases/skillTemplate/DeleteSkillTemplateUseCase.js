...
exports.DeleteSkillTemplateUseCase = void 0;
const inversify_1 = require("inversify");
const types_1 = require("../../../infrastructure/di/types");
const AppError_1 = require("../../../domain/errors/AppError");
const UserRole_1 = require("../../../domain/enums/UserRole");
let DeleteSkillTemplateUseCase = class DeleteSkillTemplateUseCase {
    ...
    async execute(adminUserId, templateId) {
        ...
        if (!admin || admin.role !== UserRole_1.UserRole.ADMIN) {
            throw new AppError_1.UnauthorizedError('Only admins can delete skill templates');
        }
        await this.skillTemplateRepository.delete(templateId);
    }
};
exports.DeleteSkillTemplateUseCase = DeleteSkillTemplateUseCase;
exports.DeleteSkillTemplateUseCase = DeleteSkillTemplateUseCase = __decorate([
...
//# sourceMappingURL=DeleteSkillTemplateUseCase.js.map