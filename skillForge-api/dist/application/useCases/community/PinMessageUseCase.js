...
exports.PinMessageUseCase = void 0;
...
let PinMessageUseCase = class PinMessageUseCase {
    ...
    async execute(userId, messageId) {
        ...
        if (community.adminId !== userId) {
            throw new AppError_1.ForbiddenError('Only community admin can pin messages');
        }
        message.pin(userId);
...
exports.PinMessageUseCase = PinMessageUseCase;
exports.PinMessageUseCase = PinMessageUseCase = __decorate([
