...
exports.BlockCommunityUseCase = void 0;
 ...
 */
let BlockCommunityUseCase = class BlockCommunityUseCase {
    ...
    async execute(request) {
        ...
        if (!community.isActive) {
            throw new AppError_1.BadRequestError('Community is already blocked');
        }
        ...
        if (request.reason) {
            console.log(`[BlockCommunityUseCase] Community ${request.communityId} blocked by admin ${request.adminUserId}. Reason: ${request.reason}`);
        }
        return {
...
exports.BlockCommunityUseCase = BlockCommunityUseCase;
exports.BlockCommunityUseCase = BlockCommunityUseCase = __decorate([
...
], BlockCommunityUseCase);
//# sourceMappingURL=BlockCommunityUseCase.js.map