...
exports.GetBookingByIdUseCase = void 0;
const inversify_1 = require("inversify");
const types_1 = require("../../../infrastructure/di/types");
const AppError_1 = require("../../../domain/errors/AppError");
let GetBookingByIdUseCase = class GetBookingByIdUseCase {
    ...
    async execute(bookingId, userId) {
        ...
        if (booking.learnerId !== userId && booking.providerId !== userId) {
            throw new AppError_1.ForbiddenError('Unauthorized to view this booking');
        }
        return this.bookingMapper.toDTO(booking);
    }
};
exports.GetBookingByIdUseCase = GetBookingByIdUseCase;
exports.GetBookingByIdUseCase = GetBookingByIdUseCase = __decorate([
...
//# sourceMappingURL=GetBookingByIdUseCase.js.map