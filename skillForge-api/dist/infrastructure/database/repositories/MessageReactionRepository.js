...
let MessageReactionRepository = class MessageReactionRepository {
    ...
    async findByMessageId(messageId) {
        ...
        return reactions.map(r => MessageReaction_1.MessageReaction.fromDatabaseRow(r));
    }
    async findByMessageAndUser(messageId, userId, emoji) {
        ...
        return reaction ? MessageReaction_1.MessageReaction.fromDatabaseRow(reaction) : null;
    }
};
