...
exports.SkillDetailsController = void 0;
const inversify_1 = require("inversify");
const types_1 = require("../../../infrastructure/di/types");
const HttpStatusCode_1 = require("../../../domain/enums/HttpStatusCode");
let SkillDetailsController = class SkillDetailsController {
    constructor(getSkillDetailsUseCase, responseBuilder) {
        this.getSkillDetailsUseCase = getSkillDetailsUseCase;
        this.responseBuilder = responseBuilder;
        this.getDetails = async (req, res, next) => {
            try {
                const { skillId } = req.params;
                const skillDetails = await this.getSkillDetailsUseCase.execute(skillId);
                const response = this.responseBuilder.success(skillDetails, 'Skill details retrieved successfully', HttpStatusCode_1.HttpStatusCode.OK);
...
//# sourceMappingURL=SkillDetailsController.js.map