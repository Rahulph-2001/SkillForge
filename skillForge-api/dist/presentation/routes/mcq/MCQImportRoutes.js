...
const multer_1 = require("../../../config/multer"); // Import CSV multer config
let MCQImportRoutes = class MCQImportRoutes {
    ...
    setupRoutes() {
        ...
        this.router.post('/:templateId/import', multer_1.uploadCSV.single('csvFile'), this.mcqImportController.startImport);
