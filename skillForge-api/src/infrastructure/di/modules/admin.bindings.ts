...
import { type IListUsersUseCase } from '../../../application/useCases/admin/interfaces/IListUsersUseCase';
import { SuspendUserUseCase } from '../../../application/useCases/admin/SuspendUserUseCase';
import { type ISuspendUserUseCase } from '../../../application/useCases/admin/interfaces/ISuspendUserUseCase';
import { UnsuspendUserUseCase } from '../../../application/useCases/admin/UnsuspendUserUseCase';
import { type IUnsuspendUserUseCase } from '../../../application/useCases/admin/interfaces/IUnsuspendUserUseCase';
import { GetAdminDashboardStatsUseCase } from '../../../application/useCases/admin/GetAdminDashboardStatsUseCase';
import { type IGetAdminDashboardStatsUseCase } from '../../../application/useCases/admin/interfaces/IGetAdminDashboardStatsUseCase';
import { ListCommunitiesUseCase } from '../../../application/useCases/admin/ListCommunitiesUseCase';
import { type IListCommunitiesUseCase } from '../../../application/useCases/admin/interfaces/IListCommunitiesUseCase';
import { UpdateCommunityByAdminUseCase } from '../../../application/useCases/admin/UpdateCommunityByAdminUseCase';
import { type IUpdateCommunityByAdminUseCase } from '../../../application/useCases/admin/interfaces/IUpdateCommunityByAdminUseCase';
import { BlockCommunityUseCase } from '../../../application/useCases/admin/BlockCommunityUseCase';
import { type IBlockCommunityUseCase } from '../../../application/useCases/admin/interfaces/IBlockCommunityUseCase';
import { UnblockCommunityUseCase } from '../../../application/useCases/admin/UnblockCommunityUseCase';
import { type IUnblockCommunityUseCase } from '../../../application/useCases/admin/interfaces/IUnblockCommunityUseCase';
import { ListPendingSkillsUseCase } from '../../../application/useCases/admin/ListPendingSkillsUseCase';
import { type IListPendingSkillsUseCase } from '../../../application/useCases/admin/interfaces/IListPendingSkillsUseCase';
import { ApproveSkillUseCase } from '../../../application/useCases/admin/ApproveSkillUseCase';
import { type IApproveSkillUseCase } from '../../../application/useCases/admin/interfaces/IApproveSkillUseCase';
import { RejectSkillUseCase } from '../../../application/useCases/admin/RejectSkillUseCase';
import { type IRejectSkillUseCase } from '../../../application/useCases/admin/interfaces/IRejectSkillUseCase';
import { GetAllSkillsUseCase } from '../../../application/useCases/admin/GetAllSkillsUseCase';
import { type IGetAllSkillsUseCase } from '../../../application/useCases/admin/interfaces/IGetAllSkillsUseCase';
import { BlockSkillUseCase } from '../../../application/useCases/admin/BlockSkillUseCase';
import { type IBlockSkillUseCase } from '../../../application/useCases/admin/interfaces/IBlockSkillUseCase';
import { UnblockSkillUseCase } from '../../../application/useCases/admin/UnblockSkillUseCase';
import { type IUnblockSkillUseCase } from '../../../application/useCases/admin/interfaces/IUnblockSkillUseCase';
import { AdminListSkillsUseCase } from '../../../application/useCases/admin/AdminListSkillsUseCase';
import { type IAdminListSkillsUseCase } from '../../../application/useCases/admin/interfaces/IAdminListSkillsUseCase';
import { AdminSkillMapper } from '../../../application/mappers/AdminSkillMapper';
import { type IAdminSkillMapper } from '../../../application/mappers/interfaces/IAdminSkillMapper';
import { GetAdminWalletStatsUseCase } from '../../../application/useCases/admin/GetAdminWalletStatsUseCase';
import { type IGetAdminWalletStatsUseCase } from '../../../application/useCases/admin/interfaces/IGetAdminWalletStatsUseCase';
import { GetWalletTransactionsUseCase } from '../../../application/useCases/admin/GetWalletTransactionsUseCase';
import { type IGetWalletTransactionsUseCase } from '../../../application/useCases/admin/interfaces/IGetWalletTransactionsUseCase';
import { CreditAdminWalletUseCase } from '../../../application/useCases/admin/CreditAdminWalletUseCase';
import { type ICreditAdminWalletUseCase } from '../../../application/useCases/admin/interfaces/ICreditAdminWalletUseCase';
import { GetAdminCreditTransactionsUseCase } from '../../../application/useCases/admin/GetAdminCreditTransactionsUseCase';
import { type IGetAdminCreditTransactionsUseCase } from '../../../application/useCases/admin/interfaces/IGetAdminCreditTransactionsUseCase';
import { GetAdminCreditStatsUseCase } from '../../../application/useCases/admin/GetAdminCreditStatsUseCase';
import { type IGetAdminCreditStatsUseCase } from '../../../application/useCases/admin/interfaces/IGetAdminCreditStatsUseCase';
import { AdminListProjectsUseCase } from '../../../application/useCases/admin/AdminListProjectsUseCase';
import { type IAdminListProjectsUseCase } from '../../../application/useCases/admin/interfaces/IAdminListProjectsUseCase';
import { AdminGetProjectStatsUseCase } from '../../../application/useCases/admin/AdminGetProjectStatsUseCase';
import { type IAdminGetProjectStatsUseCase } from '../../../application/useCases/admin/interfaces/IAdminGetProjectStatsUseCase';
...
import { type IAdminGetProjectDetailsUseCase } from '../../../application/useCases/admin/interfaces/IAdminGetProjectDetailsUseCase';
import { AdminSuspendProjectUseCase } from '../../../application/useCases/admin/AdminSuspendProjectUseCase';
import { type IAdminSuspendProjectUseCase } from '../../../application/useCases/admin/interfaces/IAdminSuspendProjectUseCase';
