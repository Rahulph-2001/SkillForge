...
export class EmailService implements IEmailService {
  ...
  async sendOTPEmail(email: string, otpCode: string, userName: string): Promise<void> {
    const mailOptions = {
      from: env.EMAIL_FROM,
      to: email,
      ...
      html: `
        ...
        <body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
          <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <p>You've received <strong>${env.DEFAULT_BONUS_CREDITS} free credits</strong> to get started. Explore skills, book sessions, and start learning!</p>
  ...
  async sendPasswordResetOTPEmail(email: string, otpCode: string, userName: string): Promise<void> {
    const mailOptions = {
      from: env.EMAIL_FROM,
      to: email,
